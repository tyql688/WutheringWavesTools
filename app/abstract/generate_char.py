from app.abstract.abstract import WavesCharRegister
from app.abstract.abstract_char import CharAbstract
...
WavesCharRegister.register_class(Char_1409.id, Char_1409)
...
WavesCharRegister.register_class(Char_1507.id, Char_1507)
